...
export default function RoadmapPage() {
  ...
  return (
    <>
      <Head>
        <title>BronToken Roadmap | From Genesis to Greatness</title>
        <meta
          name="description"
          content="Explore BronToken's journey from concept to community, game airdrops, smart contracts, and official launch. See what's completed and what's coming next."
        />
        <meta
          name="keywords"
          content="BronToken roadmap, crypto roadmap, Web3 project phases, game airdrop, launch, token launch, roadmap 2025, LeBron tribute"
        />
        <meta name="robots" content="index, follow" />

        {/* Open Graph for social sharing */}
        <meta property="og:title" content="BronToken Roadmap | The Journey Ahead" />
        <meta
          property="og:description"
          content="Track BronToken's development stages: from brainstorming and development to airdrop gaming integration and official launch."
        />
        <meta property="og:image" content="https://brontoken.com/images/roadmap-preview.png" />
        <meta property="og:url" content="https://brontoken.com/roadmap" />
        <meta property="og:type" content="website" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="BronToken Roadmap | The Path to Web3 Legacy" />
        <meta
          name="twitter:description"
          content="Every milestone matters. From the first discussion to the launch—and even a LeBron meme tribute—see the full journey of BronToken."
        />
        <meta name="twitter:image" content="https://brontoken.com/images/roadmap-preview.png" />
      </Head>
