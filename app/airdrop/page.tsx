                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div className="p-3 rounded-lg bg-black/20 border border-gray-700">
                          <div className="text-lg font-bold text-[#fdb927]">500M</div>
                          <div className="text-xs text-gray-400">Total Supply</div>
                        </div>
                        <div className="p-3 rounded-lg bg-black/20 border border-gray-700">
                          <div className="text-lg font-bold text-[#552583]">5%</div>
                          <div className="text-xs text-gray-400">Airdrop Pool</div>
                        </div>
                        <div className="p-3 rounded-lg bg-black/20 border border-gray-700">
                          <div className="text-lg font-bold text-[#00d4ff]">25M</div>
...
function LoadingScreen() {
  ...
  return (
    <div className="text-center justify-center flex flex-col w-full min-h-screen bg-black text-white">
      <p className="text-3xl mb-2">Loading your airdrop game...</p>
