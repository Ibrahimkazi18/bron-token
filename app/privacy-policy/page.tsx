...
export default function PolicyPage() {
  ...
  return (
    <>
      <Head>
        <title>Privacy Policy | Bron Token - LeBron James Inspired Meme Coin</title>
        <meta
          name="description"
          content="Read Bron Token's Privacy Policy. Learn how we collect, use, and protect your wallet and social data in our basketball-themed Web3 crypto project."
        />
        <meta
          name="keywords"
          content="bron token privacy, brontoken policy, lebron crypto privacy policy, bron solana data usage, meme coin data policy, bron token legal"
        />
        <meta name="robots" content="index, follow" />

        {/* Open Graph */}
        <meta property="og:title" content="Privacy Policy | Bron Token - Web3 Meme Coin" />
        <meta property="og:description" content="Your privacy matters. Learn how Bron Token handles data and security in this LeBron-inspired crypto project." />
        <meta property="og:image" content="https://brontoken.com/images/BronTokenLogo.png" />
        <meta property="og:url" content="https://brontoken.com/privacy-policy" />
        <meta property="og:type" content="website" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Privacy Policy | Bron Token" />
        <meta name="twitter:description" content="Understand how Bron Token collects, protects, and uses your data in a secure Web3 environment." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "Privacy Policy",
              "description": "Privacy Policy for Bron Token. Learn how we use and protect your data.",
              "url": "https://brontoken.com/privacy-policy",
              "publisher": {
                "@type": "Organization",
                "name": "Bron Token",
                ...
                "logo": {
                  "@type": "ImageObject",
                  "url": "https://brontoken.com/images/BronTokenLogo.png"
                }
              }
            })
          }}
